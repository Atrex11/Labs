public class PersonInfo5 {
    ...
    public static String lastName = "Mahanna";
    public static int studentNo = 300059693;
    public static String description = "This is a description - This is the last change";
